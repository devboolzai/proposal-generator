...
הקצאה שלא הבשילה להצעה שנשלחה משאירה חור ברצף — זה תקין ומצופה. ההקצאה אינה
אטומית (ל-Blob אין compare-and-swap), ולכן שתי הקצאות **בו-זמנית ממש** יקבלו את
אותו מספר; ההנחה היא שלא עובדים על שתי הצעות באותו רגע.
